...
export default function PatientRegistration() {
  ...
  const generateConsultationCard = async (patient: PatientData) => {
    ...
    try {
      ...
      pdf.text('Patient Consultation Card', pageWidth / 2, 23, { align: 'center' });
      ...
      pdf.setFont('helvetica', 'normal');
      pdf.setTextColor(0, 0, 0);
      pdf.text(patient.fullName, col1X, yPos);
      pdf.text(patient.mru, col2X, yPos);
      pdf.text(patient.visitId, col3X, yPos);
      ...
      pdf.setFont('helvetica', 'normal');
      pdf.setTextColor(0, 0, 0);
      pdf.text(`${patient.age} / ${patient.gender}`, col1X, yPos);
      pdf.text(patient.bloodGroup || 'N/A', col2X, yPos);
      pdf.text(patient.contactPhone, col3X, yPos);
      ...
      pdf.setFont('helvetica', 'bold');
      pdf.setTextColor(0, 0, 0);
      pdf.text('Next Appointment', rightBoxX + 2, footerY + 6);
      
      pdf.setFontSize(7);
      pdf.setFont('helvetica', 'normal');
      pdf.setTextColor(80, 80, 80);
      pdf.text('Date: __________  Time: _______', rightBoxX + 2, footerY + 15);
